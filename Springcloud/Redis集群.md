...
|       IP       | PORT |  角色  |
| :------------: | :--: | :----: |
| 192.168.48.128 | 7001 | master |
| 192.168.48.128 | 7002 | slave  |
| 192.168.48.128 | 7003 | slave  |
...
```properties
# redis实例的声明 IP
replica-announce-ip 192.168.48.128
```
...
```sh
# 逐一执行
sed -i '1a replica-announce-ip 192.168.48.128' 7001/redis.conf
sed -i '1a replica-announce-ip 192.168.48.128' 7002/redis.conf
sed -i '1a replica-announce-ip 192.168.48.128' 7003/redis.conf

# 或者一键修改
printf '%s\n' 7001 7002 7003 | xargs -I{} -t sed -i '1a replica-announce-ip 192.168.48.128' {}/redis.conf
```
...
| 节点 |       IP       | PORT  |
| ---- | :------------: | :---: |
| s1   | 192.168.48.128 | 27001 |
| s2   | 192.168.48.128 | 27002 |
| s3   | 192.168.48.128 | 27003 |
...
```ini
port 27001
sentinel announce-ip 192.168.48.128
sentinel monitor mymaster 192.168.48.128 7001 2
...
- `sentinel monitor mymaster 192.168.48.128 7001 2`：指定主节点信息
  - `mymaster`：主节点名称，自定义，任意写
  - `192.168.48.128 7001`：主节点的ip和端口
  - `2`：选举master时的quorum值
...
| :------------: | :--: | :----: |
| 192.168.48.128 | 7001 | master |
| 192.168.48.128 | 7002 | master |
| 192.168.48.128 | 7003 | master |
| 192.168.48.128 | 8001 | slave  |
| 192.168.48.128 | 8002 | slave  |
| 192.168.48.128 | 8003 | slave  |
...
# 创建集群
./redis-trib.rb create --replicas 1 192.168.48.128:7001 192.168.48.128:7002 192.168.48.128:7003 192.168.48.128:8001 192.168.48.128:8002 192.168.48.128:8003
```
...
```sh
redis-cli --cluster create --cluster-replicas 1 192.168.48.128:7001 192.168.48.128:7002 192.168.48.128:7003 192.168.48.128:8001 192.168.48.128:8002 192.168.48.128:8003
```
